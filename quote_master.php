...
Description: This adds random quotes to the admin dashboard, as well as features new widget.  Also features easy to use shortcode: [quotemaster] for your posts.
Author: Frank Corso
Version: 2.2.1
