...
Human beings are the only creatures that allow thier children to come back home.
...
<p>Currently, there are only two options here.  However, look here in future versions to edit and add quotes as well as select which categories you would like displayed.  To turn off the dashboard quotes, uncheck the first box.  If you would rather the quote change only once every 30 minutes rather than every time the page is loaded, uncheck the second box.</p>
