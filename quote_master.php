...
Description: This adds a widget that displays random quotes as well as features new easy to use shortcode: [quotemaster] for your posts.  Also, this has the option to add random quotes to the admin dashboard.  Use option menu to configure.  Now supports 3 languages.
Author: Frank Corso
Version: 3.9.1
...
<p>To turn off the dashboard quotes, uncheck the first box.  If you would rather the quote change in a certain amount of time rather than every time the page is loaded, uncheck the second box.  If you uncheck this setting, enter in the amount of minutes to the next change in the third setting.  Lastly, if you want the quotes in a different language, change the fourth option.</p>
