...
Description: This adds a widget that displays random quotes as well as features new easy to use shortcode: [quotemaster] for your posts.  Also, this has the option to add random quotes to the admin dashboard.
Author: Frank Corso
Version: 3.1.1
...
function Quote_Master_Menu() {
  add_options_page('Quote Master Options', 'Quote Master', 8, 'your-unique-identifier', 'quote_master_options');
}
...
<p>Currently, this only allows you to turn off the admin quotes.  However, look here in future versions to edit and add quotes as well as select which categories you would like displayed.</p>
...
<input type="hidden" name="page_options" value="show_dashboard_quotes" />
