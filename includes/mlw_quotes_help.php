...
{	
	...
	add_meta_box("wpss_mrts", 'In This Update', "mlw_quotes_wpss_mrt_meta_box2", "mlw_quotes_wpss2"); 
	...
	<div style="float:right; width:36%; " class="inner-sidebar1">
		<?php do_meta_boxes('mlw_quotes_wpss2','advanced',''); ?>	
	</div>
	...
	<div style="float:left; width:60%; " class="inner-sidebar1">
		<?php do_meta_boxes('mlw_quotes_wpss4','advanced',''); ?>	
	</div>
...
function mlw_quotes_wpss_mrt_meta_box2()
{
	?>
	<div>
	<table width='100%'>
