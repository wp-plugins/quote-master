...
elseif ( get_option('last_time') < time() - 1800)
{
$numbers = time();
...
<p>To turn off the dashboard quotes, uncheck the first box.  If you would rather the quote change only once every 30 minutes rather than every time the page is loaded, uncheck the second box.</p>

<table class="form-table">

<tr valign="top">
<th scope="row">Show Quotes in Dashboard</th>
<td>
...
<tr valign="top">
<th scope="row">Change Quote with Every Load (If this is not checked, quotes will change every 30 minutes)</th>
<td>
...
<input type="hidden" name="page_options" value="show_dashboard_quotes,change_on_load" />
...
<p>Please let me know of any suggestions you may have for future versions.  Currently, I plan on adding options to choose subject and/or category of quotes, option to make own quotes, and to add Ajax feature to change quotes without reloading web-page.  If you are happy with these, if there is something else you would like to suggest to add or even if you just want to let me know if you like the plugin or not, feel free to go to <a href="http://webdesign.vasculus.com/?page_id=43">Support Forums</a>.</p>
<h3>Support</h3>
<p>If you would like to support future works, feel free to go to the <a href="http://webdesign.vasculus.com/?page_id=48">Donation Page</a>.  50% of donations are given to local school events and organizations.  The local marching band is in need of new marching uniforms, please help me sponsor them.</p>
