...
{
	delete_option('quote_master_db_version');
	$data = 0;
	...
	if($wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name) 
	{
		...
		$insert = "INSERT INTO " . $table_name .
		"(quote_id, quote, author, cate) " .
           	"VALUES (NULL , 'It is a great ability to be able to conceal ones ability.', 'Unknown', '1')";
		$results = $wpdb->query( $insert );
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'I think age is a very high price to pay for maturity.', 'Tom Stoppard', '4')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'When you're eighteen your emotions are violent, but they're not durable.', 'W. Somerset Maugham', '4')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'My idea of an agreeable person is a person who agrees with me.', 'Benjamin Disraeli', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Those who agree with us may not be right, but we admire their astuteness.', 'Cullen Hightower', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'We rarely think people have good sense unless they agree with us.', 'Francois de La Rochefoucauld', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'If two men agree on everything, you may be sure that one of them is doing the thinking.', 'Lyndon B. Johnson', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'I don't necessarily agree with everything I say.', 'Marshall McLuhan', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'If you can find something everyone agrees on, it's wrong.', 'Mo Udall', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Whenever people agree with me I always feel I must be wrong.', 'Oscar Wilde', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'The greatest mistake is trying to be more agreeable than you can be.', 'Walter Bagehot', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'When two men in business always agree, one of them is unnecessary.', 'William Wrigley Jr.', '5')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Anger makes you smaller, while forgiveness forces you to grow beyond what you were.', 'Cherie Carter-Scott', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'When anger rises, think of the consequences.', 'Confucius', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Anger makes dull men witty, but it keeps them poor.', 'Elizabeth I', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Anger at lies lasts forever. Anger at truth can't last.', 'Greg Evans', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Anger is a signal, and one worth listening to.', 'Harriet Lerner', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Never forget what a man says to you when he is angry.', 'Henry Ward Beecher', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Speak when you are angry--and you will make the best speech you'll ever regret.', 'Laurence J. Peter', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Never get angry. Never make a threat. Reason with people.', 'Mario Puzo', '6')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'He who strikes the first blow admits he's lost the argument.', 'Chinese Proverb', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Use soft words and hard arguments.', 'English Proverb', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'The thing I hate about an argument is that it always interrupts a discussion.', 'G. K. Chesterton', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Silence is one of the hardest arguments to refute.', 'Josh Billings', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Behind every argument is someone's ignorance.', 'Louis D. Brandeis', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Arguments are to be avoided; they are always vulgar and often convincing.', 'Oscar Wilde', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'It is not necessary to understand things in order to argue about them.', 'Pierre Beaumarchais', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'In a heated argument we are apt to lose sight of the truth.', 'Publilius Syrus', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'It is impossible to defeat an ignorant man in argument.', 'William G. McAdoo', '7')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'A positive attitude may not solve all your problems, but it will annoy enough people to make it worth the effort.', 'Herm Albright', '8')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Complaining is good for you as long as you're not complaining to the person you're complaining about.', 'Lynn Johnston', '8')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'A strong positive mental attitude will create more miracles than any wonder drug.', 'Patricia Neal', '8')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Human beings, by changing the inner attitudes of their minds, can change the outer aspects of their lives.', 'William James', '8')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'The greatest discovery of my generation is that a human being can alter his life by altering his attitudes of mind.', 'William James', '8')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'We can be sure that the greatest hope for maintaining equilibrium in the face of any situation rests within ourselves.', 'Francis J. Braceland', '9')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'What I dream of is an art of balance.', 'Henri Matisse', '9')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'So divinely is the world organized that every one of us, in our place and time, is in balance with everything else.', 'Johann Wolfgang von Goethe', '9')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'Order is not pressure which is imposed on society from without, but an equilibrium which is set up from within.', 'Jose Ortega y Gasset', '9')";
		...
		"(quote_id, quote, author, cate) " .
           	...
           	"VALUES (NULL , 'I've learned that you can't have everything and do everything at the same time.', 'Oprah Winfrey', '9')";
