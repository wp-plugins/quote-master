...
<td><select name="quote_category"><?php $opt_ply = get_option('quote_category'); ?>
		...
		<option value="5" <?php if( $opt_ply == '5'){ echo 'selected'; } ?>>Agreement</option>
		<option value="6" <?php if( $opt_ply == '6'){ echo 'selected'; } ?>>Anger</option>
		<option value="7" <?php if( $opt_ply == '7'){ echo 'selected'; } ?>>Argument</option>
		<option value="8" <?php if( $opt_ply == '8'){ echo 'selected'; } ?>>Attitude</option>
		<option value="9" <?php if( $opt_ply == '9'){ echo 'selected'; } ?>>Balance</option>
       </select>
</td>
</tr>
</thead>
